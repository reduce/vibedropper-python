...
class TestVibedropper:
    ...
    def test_hardcoded_query_params_in_url(self, client: Vibedropper) -> None:
...
class TestAsyncVibedropper:
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncVibedropper) -> None:
