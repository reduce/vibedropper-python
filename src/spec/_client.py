...
from ._exceptions import SpecError, APIStatusError
...
__all__ = ["Timeout", "Transport", "ProxiesTypes", "RequestOptions", "Spec", "AsyncSpec", "Client", "AsyncClient"]


class Spec(SyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Spec client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("SPEC_BASE_URL")
        if base_url is None:
    ...
    @cached_property
    def with_raw_response(self) -> SpecWithRawResponse:
        return SpecWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> SpecWithStreamedResponse:
        return SpecWithStreamedResponse(self)
...
class AsyncSpec(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncSpec client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncSpecWithRawResponse:
        return AsyncSpecWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncSpecWithStreamedResponse:
        return AsyncSpecWithStreamedResponse(self)
...
class AsyncSpecWithRawResponse:
    _client: AsyncSpec

    def __init__(self, client: AsyncSpec) -> None:
        self._client = client
...
class SpecWithStreamedResponse:
    _client: Spec
...
class AsyncSpecWithStreamedResponse:
    _client: AsyncSpec
